      ...
      <header id="main-header" data-height-onload="99">
        <div className="container clearfix et_menu_container">
          <div className="logo_container">
            ...
            <a href="index.html">
              <img src="./facebook.png" width="2214" height="674" alt="COSAP" id="logo"
                data-height-percentage="56" />
            </a>
          </div>
          <div id="et-top-navigation" data-height="99" data-fixed-height="40">
            <nav id="top-menu-nav">
              <ul id="top-menu" className="nav">
                ...
                <li className="page_item page-item-345"><a
                  href="index.php/beneficios-cosap/index.html">Beneficios Cosap</a></li>
                <li className="page_item page-item-47"><a href="index.php/blog/index.html">Blog</a></li>
                <li className="page_item page-item-97"><a href="index.php/boleta-de-servicio/index.html">Boletas
                  de Servicio</a></li>
              </ul>
            </nav>
                  ...
                  <div className="et_builder_inner_content et_pb_gutters3">
                      <div
                          ...
                          <span className="et_parallax_bg_wrap"><span className="et_parallax_bg"
                                  style={{backgroundImage: "url(../coopaguacastelli.com/wp-content/uploads/2022/03/it-services-02.html)"}}
                                  >
                                  </span>
                          </span>
                                      ...
                                      <div className="et_pb_blurb_content">
                                          ...
                                          <div className="et_pb_blurb_container">
                                              <h4 className="et_pb_module_header"><a
                                                      href="index.php/boleta-de-servicio/index.html">boletas
                                                      de servicios</a></h4>
                      ...
                      <div
                          ...
                          <span className="et_parallax_bg_wrap"><span className="et_parallax_bg"
                                  style={{backgroundImage: "url(../coopaguacastelli.com/wp-content/uploads/2022/03/it-services-04.html)"}}
                                  ></span></span>
                                  ...
                                  <div className="header-image-container center">
                                      <div className="header-image">
                                          <img width="540" height="540"
                                              src="../coopaguacastelli.com/wp-content/uploads/2022/03/it-services-03.html"
                                              alt="" title=""
                                              srcSet="https://cosap.com.ar/wp-content/uploads/2022/03/it-services-03.png 540w, https://cosap.com.ar/wp-content/uploads/2022/03/it-services-03-480x480.png 480w"
